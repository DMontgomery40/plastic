...
[shared review record](SHARED_SCRATCHPAD.md). ASTRA-030 through ASTRA-032 record open UI,
claim-labeling, and calibration-test issues at backup checkpoint `6c174c1`.
That checkpoint is work in progress, not a passing release.
