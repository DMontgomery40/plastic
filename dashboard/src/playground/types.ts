...
export interface SleepMeasurement {
  ...
  recall: { n_probes: number; recalled: number; recalled_exact: number; n_paraphrase: number; recalled_paraphrase: number; distinct_ratio?: number | null; max_cluster_share?: number | null } | null;
}
