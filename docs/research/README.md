...
| Harness, calibration, safety experiments | [Safety review](2026-09-21-inference-time-learning-safety.md), [calibration replay audit](2026-09-22-calibration-replay-audit.md), and the coordinate proposal's transaction semantics if that candidate is involved |
